...
Ex().multi(
    check_function("apples.hist", index=0, signature=False).check_args(0).has_equal_output(),
    ...
    check_function("apples.hist", index=1, signature=False).check_args(0).has_equal_output(),
